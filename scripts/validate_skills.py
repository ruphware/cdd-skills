...
def validate_maintain_mode_boundaries(skill_text: str, skill_md: Path) -> None:
    ...
    require_topic_bundle(
        ...
        (
            ...
            r"continue with available repo signals and report the missing inputs rather than failing or inventing content",
            r"GitHub-safe mermaid diagrams from the rebuilt repo model",
...
def validate_maintain_skill_text(skill_text: str, skill_md: Path) -> None:
    ...
    require_topic_bundle(
        ...
        (
            ...
            r"Do not use prior `docs/INDEX\.md` prose, diagrams, inventories, or summaries as semantic input",
