...
assert_exists "$OPENCLAW_INSTALL/cdd-master-chef/master-chef/CONTRACT.md"
assert_exists "$OPENCLAW_INSTALL/cdd-master-chef/master-chef/CODEX-ADAPTER.md"
...
assert_exists "$OPENCLAW_LINK/cdd-master-chef/master-chef/RUNBOOK.md"
