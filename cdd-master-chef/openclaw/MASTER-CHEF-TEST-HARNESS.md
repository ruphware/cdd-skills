...
- [ ] Run ended with `RUN_COMPLETE`, `RUN_STOPPED`, a hard-stop `STEP_BLOCKED`, or `DEADLOCK_STOPPED`, and emitted a final mission report with completed TODO step ids, fully checked task checklists, and distinct closeout or continuation recommendations.
